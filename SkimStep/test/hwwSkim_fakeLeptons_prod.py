...
process.patJetsWithTriggerPF = cms.EDProducer( "PATTriggerMatchJetEmbedder",
    src     = cms.InputTag(  "patJetsPF" ),
...
process.cleanPatJetsPF.src = "patJetsWithTriggerPF"
process.cleanPatJetsNoPU.src = "patJetsWithTriggerNoPU"
process.autreSeq.replace(process.cleanPatJetsPF,   process.jetTriggerMatchHLT *     process.patJetsWithTriggerPF *   process.cleanPatJetsPF)
...
for X,P in [ ("muonsJetFilter",         1), 
             ...
             ("muonsUnbiasTrigger",     4),  ## <- NOTE the prescale
...
process.out.fileName = 'hwwSkim_fakeLeptons.root' 
process.source.fileNames = [
	'/store/data/Run2010B/Jet/RECO/PromptReco-v2/000/148/822/F6D0E2B4-6BE0-DF11-BEA8-000423D996C8.root',
	'/store/data/Run2010B/Jet/RECO/PromptReco-v2/000/148/822/C87CDC84-88E0-DF11-85A7-003048F11CF0.root',
	'/store/data/Run2010B/Jet/RECO/PromptReco-v2/000/148/822/4E63312A-72E0-DF11-82F6-0030487CD76A.root',
]
