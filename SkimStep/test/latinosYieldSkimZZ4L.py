...
process.source.fileNames = ['file:/data/gpetrucc/7TeV/hzz/aod/HToZZTo4L_M-120_Fall11S6.00215E21D5C4.root'] #on lxplus423.cern.ch
...
process.pfIsoSequence = cms.Sequence( 
    ...
    + process.hzz4lDetectorIsolationSequence
)
...
process.allDiLep.decay = "noTauLeps noTauLeps"
