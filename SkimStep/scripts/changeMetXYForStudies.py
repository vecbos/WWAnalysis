...
##
    ...
    def applyMetXYshift(self):
        ...
        self.ttree.Branch("shifted_dphillmet",dphillmet,"shifted_dphillmet/F")
        self.ttree.Branch("shifted_dphilmet" ,dphilmet ,"shifted_dphilmet/F")
        self.ttree.Branch("shifted_dphilmet1",dphilmet1,"shifted_dphilmet1/F")
        self.ttree.Branch("shifted_dphilmet2",dphilmet2,"shifted_dphilmet2/F")
        self.ttree.Branch("shifted_mth"      ,mth      ,"shifted_mth/F")
        self.ttree.Branch("shifted_mtw1"     ,mtw1     ,"shifted_mtw1/F")
        self.ttree.Branch("shifted_mtw2"     ,mtw2     ,"shifted_mtw2/F")
        self.ttree.Branch("shifted_pfmet"    ,pfmet    ,"shifted_pfmet/F")
        self.ttree.Branch("shifted_pfmetphi" ,pfmetphi ,"shifted_pfmetphi/F")
        self.ttree.Branch("shifted_ppfmet"   ,ppfmet   ,"shifted_ppfmet/F")
        self.ttree.Branch("shifted_mpmet"    ,mpmet    ,"shifted_mpmet/F")
        self.ttree.Branch("shifted_dymva0"   ,dymva0   ,"shifted_dymva0/F")
        self.ttree.Branch("shifted_dymva1"   ,dymva1   ,"shifted_dymva1/F")
