...
process.eventHists.hypotheses.wwmumu00 = cms.PSet(src = cms.InputTag("wwmumu0"), cuts = cloneVPSet(process.eventHists.hypotheses.wwelel0.cuts))
process.eventHists.hypotheses.wwelmu00 = cms.PSet(src = cms.InputTag("wwelmu0"), cuts = cloneVPSet(process.eventHists.hypotheses.wwelel0.cuts))
process.eventHists.hypotheses.wwmuel00 = cms.PSet(src = cms.InputTag("wwmuel0"), cuts = cloneVPSet(process.eventHists.hypotheses.wwelel0.cuts))
process.eventHists.hypotheses.wwelel00 = cms.PSet(src = cms.InputTag("wwelel0"), cuts = cloneVPSet(process.eventHists.hypotheses.wwelel0.cuts))
