...
for S,C in selections.items():
    ...
    yields[S] = {
        ...
        'tt' :   reports[S]['.010_TTJetsMad'][-1][1][index][1],
        'tw' :   reports[S]['.011_TtWFullDR'][-1][1][index][1] + 
                 reports[S]['.012_TbartWFullDR'][-1][1][index][1],
    ...
    yieldErrs[S] = {
        ...
        'tt' :   reports[S]['.010_TTJetsMad'][-1][1][index][2],
        'tw' :   reports[S]['.011_TtWFullDR'][-1][1][index][2] + 
                 reports[S]['.012_TbartWFullDR'][-1][1][index][2],
