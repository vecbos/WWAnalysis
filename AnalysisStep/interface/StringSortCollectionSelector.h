#ifndef WWAnalysis_AnalysisStep_StringSortCollectionSelector_h
#define WWAnalysis_AnalysisStep_StringSortCollectionSelector_h
/** \class StringSortCollectionSelector
 ...
 * \author Luca Lista, INFN; hacked by Adish Vartak to allow string-parsed comparators
...
public:
  StringSortCollectionSelector(const edm::ParameterSet & cfg) : 
    compare_(reco::modules::make<Comparator>(cfg)),
