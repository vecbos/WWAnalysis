...
#include <cmath>
  ...
  AngularPdfFactory::AngularPdfFactory(RooRealVar* m1,RooRealVar* m2,RooRealVar* h1,RooRealVar* h2,RooRealVar* Phi,RooRealVar* mZZ){
  ...
  AngularPdfFactory::~AngularPdfFactory(){
  ...
  void AngularPdfFactory::makeSMHiggs(){
    a1Val->setVal(1.0);
    phi1Val->setVal(0.0);
    a2Val->setVal(0.0);
    phi2Val->setVal(0.0);
  ...
  void AngularPdfFactory::makeLGHiggs(){          
  ...
  void AngularPdfFactory::makePSHiggs(){
    a1Val->setVal(0.0);
    phi1Val->setVal(0.0);
    a2Val->setVal(0.0);
    phi2Val->setVal(0.0);
  ...
  void AngularPdfFactory::makeCustom(double a1, double a2, double a3,
  ...
  void AngularPdfFactory::makeParamsConst(bool yesNo){
    if(yesNo){
...
void  AngularPdfFactory::initNorm() {
  ...
  double AngularPdfFactory::getVal(double mZZ){
  ...
  double AngularPdfFactory::getValIntegrOutAngles(RooRealVar* m1,RooRealVar* m2,RooRealVar* h1,RooRealVar* h2,RooRealVar* Phi,RooRealVar* mZZ){
