...
h120Samples = {
    ...
    '102120':  ['ggToH120toWWtoLNuTauNu', 0.001009201],
    '103120':  ['ggToH120toWWto2Tau2Nu', 0.0004197224],
    '104120':  ['vbfToH120toWWto2L2Nu', 0.0002410953],
...
h130Samples = {
    ...
    '103130':  ['ggToH130toWWto2Tau2Nu', 0.000762179],
...
h140Samples = {
    ...
    '104140':  ['vbfToH140toWWto2L2Nu', 0.0002984856],
...
h160Samples = {
    ...
    '104160':  ['vbfToH160toWWto2L2Nu', 0.0004348646],
...
h180Samples = {
    '101180':  ['ggToH180toWWto2L2Nu', 0.002691811],
...
h200Samples = {
    ...
    '102200':  ['ggToH200toWWtoLNuTauNu', 0.001656469],
...
h250Samples = {
    ...
    '106250':  ['vbfToH250toWWto2Tau2Nu', 0.000053093],
}
...
h450Samples = {
    ...
    '102450':  ['ggToH450toWWtoLNuTauNu', 0.000320064],
...
h500Samples = {
    ...
    '104500':  ['vbfToH500toWWto2L2Nu', 0.0000285293],
...
h550Samples = {
    ...
    '103550':  ['ggToH550toWWto2Tau2Nu', 0.000053044],
...
h600Samples = {
    ...
    '103600':  ['ggToH600toWWto2Tau2Nu', 0.000033345],
    '104600':  ['vbfToH600toWWto2L2Nu', 0.0000183961],
