...
#        ptcmet = cms.string("projTcMet"),
        ...
        dphilljet  = cms.string("dPhillLeadingJet(5.0,1,"+str(jetId_WP)+")"),
        dphilljetjet = cms.string("dPhilljetjet(5.0,1,"+str(jetId_WP)+")"),   #WHAT
        ...
        njet  = cms.string("nCentralJets(30,5.0,1,"+str(jetId_WP)+")"),
        njetid  = cms.string("nCentralJets(30,5.0,1,0)"), 
        # here we do apply a dz cut cause we are actually counting bjets
        nbjet = cms.string("bTaggedJetsOver(30,2.1,'trackCountingHighEffBJetTags',"+str(jetId_WP)+",2.0)"),
        # here we don't apply the dz cut, cause we just use the b-tag value of highest pt jets
        jetpt1   = cms.string("leadingJetPt(0,0,5.0,1,"+str(jetId_WP)+")"),
        jeteta1  = cms.string("leadingJetEta(0,0,5.0,1,"+str(jetId_WP)+")"),
        jetphi1  = cms.string("leadingJetPhi(0,0,5.0,1,"+str(jetId_WP)+")"),
        jetid1   = cms.string("leadingJetId(0,0,5.0,1,"+str(jetId_WP)+")"),
        jetmva1   = cms.string("leadingJetMva(0,0,5.0,1,"+str(jetId_WP)+")"),
        jettche1 = cms.string("leadingJetBtag(0,'trackCountingHighEffBJetTags',0,5.0,1,"+str(jetId_WP)+")"),
        jettchp1 = cms.string("leadingJetBtag(0,'trackCountingHighPurBJetTags',0,5.0,1,"+str(jetId_WP)+")"),
        jetpt2   = cms.string("leadingJetPt(1,0,5.0,1,"+str(jetId_WP)+")"),
        jeteta2  = cms.string("leadingJetEta(1,0,5.0,1,"+str(jetId_WP)+")"),
        jetphi2  = cms.string("leadingJetPhi(1,0,5.0,1,"+str(jetId_WP)+")"),
        jetid2   = cms.string("leadingJetId(1,0,5.0,1,"+str(jetId_WP)+")"),
        jetmva2  = cms.string("leadingJetMva(1,0,5.0,1,"+str(jetId_WP)+")"),
        jettche2 = cms.string("leadingJetBtag(1,'trackCountingHighEffBJetTags',0,5.0,1,"+str(jetId_WP)+")"),
        jettchp2 = cms.string("leadingJetBtag(1,'trackCountingHighEffBJetTags',0,5.0,1,"+str(jetId_WP)+")"),
        jetpt3   = cms.string("leadingJetPt(2,0,5.0,1,"+str(jetId_WP)+")"),
        jeteta3  = cms.string("leadingJetEta(2,0,5.0,1,"+str(jetId_WP)+")"),
        jetphi3  = cms.string("leadingJetPhi(2,0,5.0,1,"+str(jetId_WP)+")"),
        jetid3   = cms.string("leadingJetId(2,0,5.0,1,"+str(jetId_WP)+")"),
        jetmva3  = cms.string("leadingJetMva(2,0,5.0,1,"+str(jetId_WP)+")"),
        jetpt4   = cms.string("leadingJetPt(3,0,5.0,1,"+str(jetId_WP)+")"),
        jeteta4  = cms.string("leadingJetEta(3,0,5.0,1,"+str(jetId_WP)+")"),
        jetphi4  = cms.string("leadingJetPhi(3,0,5.0,1,"+str(jetId_WP)+")"),
        jetid4   = cms.string("leadingJetId(3,0,5.0,1,"+str(jetId_WP)+")"),
        jetmva4  = cms.string("leadingJetMva(3,0,5.0,1,"+str(jetId_WP)+")"),
        ...
        # here we do apply a dz cut cause we are actually counting bjets
        softbdisc = cms.string("highestBDiscRange(10.0,30.0,'trackCountingHighEffBJetTags',"+str(jetId_WP)+",2.0)"),
        hardbdisc = cms.string("highestBDiscRange(30.0,999999.,'trackCountingHighEffBJetTags',"+str(jetId_WP)+",2.0)"),
        ...
        fakeW   = cms.string("1"),
        #vbf stuff:
        njetvbf = cms.string("nJetVBF(30,5.,1,"+str(jetId_WP)+")"),
        mjj = cms.string("mjj(0,5.,1,"+str(jetId_WP)+")"),
        detajj = cms.string("dEtajj(30,5.,1,"+str(jetId_WP)+")"),
        cjetpt1   = cms.string("leadingVBFJetPt(0,0,5.0,1,"+str(jetId_WP)+")"),
        cjeteta1  = cms.string("leadingVBFJetEta(0,0,5.0,1,"+str(jetId_WP)+")"),
        cjetphi1  = cms.string("leadingVBFJetPhi(0,0,5.0,1,"+str(jetId_WP)+")"),
        cjetid1   = cms.string("leadingVBFJetId(0,0,5.0,1,"+str(jetId_WP)+")"),
        cjetmva1   = cms.string("leadingVBFJetMva(0,0,5.0,1,"+str(jetId_WP)+")"),
        cjetpt2   = cms.string("leadingVBFJetPt(1,0,5.0,1,"+str(jetId_WP)+")"),
        cjeteta2  = cms.string("leadingVBFJetEta(1,0,5.0,1,"+str(jetId_WP)+")"),
        cjetphi2  = cms.string("leadingVBFJetPhi(1,0,5.0,1,"+str(jetId_WP)+")"),
        cjetid2  = cms.string("leadingVBFJetId(1,0,5.0,1,"+str(jetId_WP)+")"),
        cjetmva2  = cms.string("leadingVBFJetMva(1,0,5.0,1,"+str(jetId_WP)+")"),
        #zep
        # mc info
    ...
    flags = cms.PSet(
        ...
        dphiveto   = cms.string("passesDPhillJet(15,5.0,1,"+str(jetId_WP)+")"),
...
def addBTaggingVariables(pt,dzCut=9999.):
    if hasattr(pt,"variables"):
        pt.variables.softtche = cms.string("highestBDiscRange(10.0,30.0   ,'trackCountingHighEffBJetTags',"+str(jetId_WP)+",%f)"%dzCut)
        pt.variables.hardtche = cms.string("highestBDiscRange(30.0,999999.,'trackCountingHighEffBJetTags',"+str(jetId_WP)+",%f)"%dzCut)
        pt.variables.softtchp = cms.string("highestBDiscRange(10.0,30.0   ,'trackCountingHighPurBJetTags',"+str(jetId_WP)+",%f)"%dzCut)
        pt.variables.hardtchp = cms.string("highestBDiscRange(30.0,999999.,'trackCountingHighPurBJetTags',"+str(jetId_WP)+",%f)"%dzCut)
        pt.variables.softcsv  = cms.string("highestBDiscRange(10.0,30.0   ,'combinedSecondaryVertexBJetTags',"+str(jetId_WP)+",%f)"%dzCut)
        pt.variables.hardcsv  = cms.string("highestBDiscRange(30.0,999999.,'combinedSecondaryVertexBJetTags',"+str(jetId_WP)+",%f)"%dzCut)
        pt.variables.softcsvm = cms.string("highestBDiscRange(10.0,30.0   ,'combinedSecondaryVertexMVABJetTags',"+str(jetId_WP)+",%f)"%dzCut)
        pt.variables.hardcsvm = cms.string("highestBDiscRange(30.0,999999.,'combinedSecondaryVertexMVABJetTags',"+str(jetId_WP)+",%f)"%dzCut)
        pt.variables.softjbpb = cms.string("highestBDiscRange(10.0,30.0   ,'jetBProbabilityBJetTags',"+str(jetId_WP)+",%f)"%dzCut)
        pt.variables.hardjbpb = cms.string("highestBDiscRange(30.0,999999.,'jetBProbabilityBJetTags',"+str(jetId_WP)+",%f)"%dzCut)
        pt.variables.softjpb  = cms.string("highestBDiscRange(10.0,30.0   ,'jetProbabilityBJetTags',"+str(jetId_WP)+",%f)"%dzCut)
        pt.variables.hardjpb  = cms.string("highestBDiscRange(30.0,999999.,'jetProbabilityBJetTags',"+str(jetId_WP)+",%f)"%dzCut)

        pt.variables.jetcsv1 = cms.string("leadingJetBtag(0,'combinedSecondaryVertexBJetTags',0,5.0,"+str(jetId_WP)+",1,1,%f)"%dzCut)
        pt.variables.jetcsv2 = cms.string("leadingJetBtag(1,'combinedSecondaryVertexBJetTags',0,5.0,"+str(jetId_WP)+",1,1,%f)"%dzCut)
        pt.variables.jetcsvm1 = cms.string("leadingJetBtag(0,'combinedSecondaryVertexMVABJetTags',0,5.0,"+str(jetId_WP)+",1,1,%f)"%dzCut)
        pt.variables.jetcsvm2 = cms.string("leadingJetBtag(1,'combinedSecondaryVertexMVABJetTags',0,5.0,"+str(jetId_WP)+",1,1,%f)"%dzCut)
        pt.variables.jetjbpb1 = cms.string("leadingJetBtag(0,'jetBProbabilityBJetTags',0,5.0,"+str(jetId_WP)+",1,1,%f)"%dzCut)
        pt.variables.jetjbpb2 = cms.string("leadingJetBtag(1,'jetBProbabilityBJetTags',0,5.0,"+str(jetId_WP)+",1,1,%f)"%dzCut)
        pt.variables.jetjpb1 = cms.string("leadingJetBtag(0,'jetProbabilityBJetTags',0,5.0,"+str(jetId_WP)+",1,1,%f)"%dzCut)
        pt.variables.jetjpb2 = cms.string("leadingJetBtag(1,'jetProbabilityBJetTags',0,5.0,"+str(jetId_WP)+",1,1,%f)"%dzCut)
    else:
