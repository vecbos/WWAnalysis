...
#ELE_ID_CUT=("(electronID('eidVBTFRel80') == 5 || electronID('eidVBTFRel80') == 7)"
#            );

# ELE_ID_CUT=("(electronID('eidVBTFRel80') >= 4 &&" +
ELE_ID_CUT=("(" +
...
#wwElectrons.src = "convRejSelection"
wwElectrons.filter = cms.bool(False)
 #"triggerObjectMatchesByFilter('hltL1NonIsoHLTNonIsoSingleElectronLWEt15PixelMatchFilter').size() != 0 && " +
