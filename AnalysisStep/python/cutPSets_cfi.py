...
hReOpt120 = cms.PSet( ptMin=cms.double(10), useJEC=cms.bool(True), mllMaxFinal=cms.double( 40), ptMaxFinal=cms.double( 20), ptMinFinal=cms.double(20), pMetFinal=cms.double(35), metOverPtLL=cms.double(0.0), deltaPhiLL=cms.double( 60./180*math.pi))  
hReOpt130 = cms.PSet( ptMin=cms.double(10), useJEC=cms.bool(True), mllMaxFinal=cms.double( 45), ptMaxFinal=cms.double( 25), ptMinFinal=cms.double(20), pMetFinal=cms.double(35), metOverPtLL=cms.double(0.0), deltaPhiLL=cms.double( 60./180*math.pi))  
hReOpt140 = cms.PSet( ptMin=cms.double(10), useJEC=cms.bool(True), mllMaxFinal=cms.double( 45), ptMaxFinal=cms.double( 25), ptMinFinal=cms.double(20), pMetFinal=cms.double(35), metOverPtLL=cms.double(0.0), deltaPhiLL=cms.double( 60./180*math.pi))  
hReOpt150 = cms.PSet( ptMin=cms.double(10), useJEC=cms.bool(True), mllMaxFinal=cms.double( 50), ptMaxFinal=cms.double( 27), ptMinFinal=cms.double(20), pMetFinal=cms.double(35), metOverPtLL=cms.double(0.0), deltaPhiLL=cms.double( 60./180*math.pi))  
