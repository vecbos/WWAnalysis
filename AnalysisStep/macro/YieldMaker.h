...
class YieldMaker {
    ...
    public :        
        ...
        YieldMaker():
            ...
            rrweight   (RooRealVar("weight",    "weight",    0., 1000000.)),
        ...
        void get2DHist(int channel, float z1min, float z2min, float m4lmin, float m4lmax, float melacut, TH2* hist) {
            ...
            for (int i = 0; i < dataset.numEntries(); i++) {
                ...
                //if (channel == (int)ch && z1mass>z1min && z1mass<120 && z2mass>z2min && z2min<120 && mass>m4lmin && mass<m4lmax && mela>melacut) hist->Fill(mass, 1.0, weight);
            }
        ...
        RooDataSet getFitDataSet(int channel, float z1min, float z2min, float m4lmin, float m4lmax, float melacut) {
            ...
            RooRealVar w("weight", "weight", 0.,  0.,  10.);
...
class ZZYieldMaker : public YieldMaker {
    ...
    public:
        ...
        void fill(std::string filepath, float wgt, float wgterr) {
