...
void MakeSpinTwoMinimalPlots(string filenameSMHiggs, string filenameSpinTwoMinimalHiggs, vector<pair<string,double> > ZZBkgfilenames,
  ...
  TH1F *histSpinTwoMinimalMELA_SMHiggs = new TH1F( "histSpinTwoMinimalMELA_SMHiggs", " ; SpinTwoMinimal MELA ; Number of Events", 40, 0, 1);
  TH1F *histSpinTwoMinimalMELA_AfterMELACut_SMHiggs = new TH1F( "histSpinTwoMinimalMELA_AfterMELACut_SMHiggs", " ; SpinTwoMinimal MELA ; Number of Events", 40, 0, 1);
  TH1F *histSpinTwoMinimalMELA_SpinTwoMinimalHiggs = new TH1F( "histSpinTwoMinimalMELA_SpinTwoMinimalHiggs", " ; SpinTwoMinimal MELA ; Number of Events", 40, 0, 1);
  TH1F *histSpinTwoMinimalMELA_AfterMELACut_SpinTwoMinimalHiggs = new TH1F( "histSpinTwoMinimalMELA_AfterMELACut_SpinTwoMinimalHiggs", " ; SpinTwoMinimal MELA ; Number of Events", 40, 0, 1);
  TH1F *histSpinTwoMinimalMELA_ZZBkg = new TH1F( "histSpinTwoMinimalMELA_ZZBkg", " ; SpinTwoMinimal MELA ; Number of Events", 40, 0, 1);
  TH1F *histSpinTwoMinimalMELA_AfterMELACut_ZZBkg = new TH1F( "histSpinTwoMinimalMELA_AfterMELACut_ZZBkg", " ; SpinTwoMinimal MELA ; Number of Events", 40, 0, 1);
  TH1F *histSpinTwoMinimalMELA_Data = new TH1F( "histSpinTwoMinimalMELA_Data", " ; SpinTwoMinimal MELA ; Number of Events", 40, 0, 1);
  TH1F *histSpinTwoMinimalMELA_AfterMELACut_Data = new TH1F( "histSpinTwoMinimalMELA_AfterMELACut_Data", " ; SpinTwoMinimal MELA ; Number of Events", 40, 0, 1);
  ...
  TH1F *histCosThetaStar_SpinTwoMinimalHiggs = new TH1F( "histCosThetaStar_SpinTwoMinimalHiggs", " ; CosThetaStar ; Number of Events", 40, -1, 1);
  TH1F *histCosTheta1_SpinTwoMinimalHiggs = new TH1F( "histCosTheta1_SpinTwoMinimalHiggs", " ; CosTheta1 ; Number of Events", 40, -1, 1);
  TH1F *histCosTheta2_SpinTwoMinimalHiggs = new TH1F( "histCosTheta2_SpinTwoMinimalHiggs", " ; CosTheta2 ; Number of Events", 40, -1, 1);
  TH1F *histPhi_SpinTwoMinimalHiggs = new TH1F( "histPhi_SpinTwoMinimalHiggs", " ; Phi ; Number of Events", 40, -3.142, 3.142);
  TH1F *histPhiStar1_SpinTwoMinimalHiggs = new TH1F( "histPhiStar1_SpinTwoMinimalHiggs", " ; PhiStar1 ; Number of Events", 40, -3.142, 3.142);
  TH1F *histZ1Mass_SpinTwoMinimalHiggs = new TH1F( "histZ1Mass_SpinTwoMinimalHiggs", " ; m_{Z1} ; Number of Events", 40, 40, 120);
  TH1F *histZ2Mass_SpinTwoMinimalHiggs = new TH1F( "histZ2Mass_SpinTwoMinimalHiggs", " ; m_{Z2} ; Number of Events", 35, 0, 70);
  TH1F *histCosThetaStar_AfterMELACut_SpinTwoMinimalHiggs = new TH1F( "histCosThetaStar_AfterMELACut_SpinTwoMinimalHiggs", " ; CosThetaStar ; Number of Events", 40, -1, 1);
  TH1F *histCosTheta1_AfterMELACut_SpinTwoMinimalHiggs = new TH1F( "histCosTheta1_AfterMELACut_SpinTwoMinimalHiggs", " ; CosTheta1 ; Number of Events", 40, -1, 1);
  TH1F *histCosTheta2_AfterMELACut_SpinTwoMinimalHiggs = new TH1F( "histCosTheta2_AfterMELACut_SpinTwoMinimalHiggs", " ; CosTheta2 ; Number of Events", 40, -1, 1);
  TH1F *histPhi_AfterMELACut_SpinTwoMinimalHiggs = new TH1F( "histPhi_AfterMELACut_SpinTwoMinimalHiggs", " ; Phi ; Number of Events", 40, -3.142, 3.142);
  TH1F *histPhiStar1_AfterMELACut_SpinTwoMinimalHiggs = new TH1F( "histPhiStar1_AfterMELACut_SpinTwoMinimalHiggs", " ; PhiStar1 ; Number of Events", 40, -3.142, 3.142);
  TH1F *histZ1Mass_AfterMELACut_SpinTwoMinimalHiggs = new TH1F( "histZ1Mass_AfterMELACut_SpinTwoMinimalHiggs", " ; m_{Z1} ; Number of Events", 40, 40, 120);
  TH1F *histZ2Mass_AfterMELACut_SpinTwoMinimalHiggs = new TH1F( "histZ2Mass_AfterMELACut_SpinTwoMinimalHiggs", " ; m_{Z2} ; Number of Events", 35, 0, 70);
  ...
  TFile* fileSpinTwoMinimalHiggs = new TFile(filenameSpinTwoMinimalHiggs.c_str());
  TTree* treeSpinTwoMinimalHiggs = (TTree*)fileSpinTwoMinimalHiggs->Get("zz4lTree/probe_tree");
  ...
  treeSMHiggs->SetBranchAddress( "GraviMELA",&melaSpinTwoMinimal);
  ...
  for (int i = 0; i < treeSMHiggs->GetEntries(); i++) {
    ...
    if (!existsAlready) {
      ...
      if (mass > 120 && mass < 130) {
        histSpinTwoMinimalMELA_SMHiggs->Fill(melaSpinTwoMinimal, weight);
        ...
        if (mela > 0.5) {
          histSpinTwoMinimalMELA_AfterMELACut_SMHiggs->Fill(melaSpinTwoMinimal, weight);
  ...
  // Loop Over SM Higgs
  //*******************************************************************
  treeSpinTwoMinimalHiggs->SetBranchAddress( "channel", &channel);
  treeSpinTwoMinimalHiggs->SetBranchAddress( "z1mass",&z1mass);
  treeSpinTwoMinimalHiggs->SetBranchAddress( "z2mass",&z2mass);
  treeSpinTwoMinimalHiggs->SetBranchAddress("mass" ,&mass);
  treeSpinTwoMinimalHiggs->SetBranchAddress( "numTrueInteractions",&numsim);
  treeSpinTwoMinimalHiggs->SetBranchAddress("l3pt" ,&l3pt);
  treeSpinTwoMinimalHiggs->SetBranchAddress("l3eta" ,&l3eta);
  treeSpinTwoMinimalHiggs->SetBranchAddress("l3idNew" ,&l3id);
  treeSpinTwoMinimalHiggs->SetBranchAddress("l3pfIsoComb04EACorr" ,&l3iso);
  treeSpinTwoMinimalHiggs->SetBranchAddress("l3pdgId" ,&l3pdgId);
  treeSpinTwoMinimalHiggs->SetBranchAddress( "l4pt",&l4pt);
  treeSpinTwoMinimalHiggs->SetBranchAddress("l4eta" ,&l4eta);
  treeSpinTwoMinimalHiggs->SetBranchAddress("l4idNew" ,&l4id);
  treeSpinTwoMinimalHiggs->SetBranchAddress( "l4pfIsoComb04EACorr",&l4iso);
  treeSpinTwoMinimalHiggs->SetBranchAddress("l4pdgId" ,&l4pdgId);
  treeSpinTwoMinimalHiggs->SetBranchAddress( "l1pt",&l1pt);
  treeSpinTwoMinimalHiggs->SetBranchAddress( "l1eta",&l1eta);
  treeSpinTwoMinimalHiggs->SetBranchAddress( "l1pdgId",&l1pdgId);
  treeSpinTwoMinimalHiggs->SetBranchAddress( "l2pt",&l2pt);
  treeSpinTwoMinimalHiggs->SetBranchAddress( "l2eta",&l2eta);
  treeSpinTwoMinimalHiggs->SetBranchAddress( "l2pdgId",&l2pdgId);
  treeSpinTwoMinimalHiggs->SetBranchAddress( "melaLD",&mela);
  treeSpinTwoMinimalHiggs->SetBranchAddress( "melaPSLD",&melaPS);
  treeSpinTwoMinimalHiggs->SetBranchAddress( "GraviMELA",&melaSpinTwoMinimal);
  treeSpinTwoMinimalHiggs->SetBranchAddress( "melaPtY",&melaPtY);
  treeSpinTwoMinimalHiggs->SetBranchAddress( "melaCosThetaStar",&melaCosThetaStar);
  treeSpinTwoMinimalHiggs->SetBranchAddress( "melaCosTheta1",&melaCosTheta1);
  treeSpinTwoMinimalHiggs->SetBranchAddress( "melaCosTheta2",&melaCosTheta2);
  treeSpinTwoMinimalHiggs->SetBranchAddress( "melaPhi",&melaPhi);
  treeSpinTwoMinimalHiggs->SetBranchAddress( "melaPhiStar1",&melaPhiStar1);
  treeSpinTwoMinimalHiggs->SetBranchAddress( "event" ,&event);
  treeSpinTwoMinimalHiggs->SetBranchAddress( "run",&run);
  treeSpinTwoMinimalHiggs->SetBranchAddress( "lumi",&lumi);
  treeSpinTwoMinimalHiggs->SetBranchAddress( "genhiggsmassweight",&higgswgt);
        
  for (int i = 0; i < treeSpinTwoMinimalHiggs->GetEntries(); i++) {
    treeSpinTwoMinimalHiggs->GetEntry(i);
    bool existsAlready = false;
    ...
    if (!existsAlready) {
      ...
      //make plot within 10GeV mass window around the higgs
      if (mass > 120 && mass < 130) {
        histSpinTwoMinimalMELA_SpinTwoMinimalHiggs->Fill(melaSpinTwoMinimal, weight);
        histCosThetaStar_SpinTwoMinimalHiggs->Fill(melaCosThetaStar, weight);
        histCosTheta1_SpinTwoMinimalHiggs->Fill(melaCosTheta1, weight);
        histCosTheta2_SpinTwoMinimalHiggs->Fill(melaCosTheta2, weight);
        histPhi_SpinTwoMinimalHiggs->Fill(melaPhi, weight);
        histPhiStar1_SpinTwoMinimalHiggs->Fill(melaPhiStar1, weight);
        histZ1Mass_SpinTwoMinimalHiggs->Fill(z1mass, weight);
        histZ2Mass_SpinTwoMinimalHiggs->Fill(z2mass, weight);
        if (mela > 0.5) {
          histSpinTwoMinimalMELA_AfterMELACut_SpinTwoMinimalHiggs->Fill(melaSpinTwoMinimal, weight);
          histCosThetaStar_AfterMELACut_SpinTwoMinimalHiggs->Fill(melaCosThetaStar, weight);
          histCosTheta1_AfterMELACut_SpinTwoMinimalHiggs->Fill(melaCosTheta1, weight);
          histCosTheta2_AfterMELACut_SpinTwoMinimalHiggs->Fill(melaCosTheta2, weight);
          histPhi_AfterMELACut_SpinTwoMinimalHiggs->Fill(melaPhi, weight);
          histPhiStar1_AfterMELACut_SpinTwoMinimalHiggs->Fill(melaPhiStar1, weight);
          histZ1Mass_AfterMELACut_SpinTwoMinimalHiggs->Fill(z1mass, weight);
          histZ2Mass_AfterMELACut_SpinTwoMinimalHiggs->Fill(z2mass, weight);
        }
      }
  ...
  for (int f=0; f < ZZBkgfilenames.size(); ++f) {
    ...
    treeZZBkg->SetBranchAddress( "GraviMELA",&melaSpinTwoMinimal);
    ...
    for (int i = 0; i < treeZZBkg->GetEntries(); i++) {
      ...
      if (!existsAlready) {
        ...
        //make plot within 10GeV mass window around the higgs
        if (mass > 120 && mass < 130) {
          histSpinTwoMinimalMELA_ZZBkg->Fill(melaSpinTwoMinimal, weight);
          ...
          if (mela > 0.5) {
            histSpinTwoMinimalMELA_AfterMELACut_ZZBkg->Fill(melaSpinTwoMinimal, weight);
  ...
  for (int f=0; f < filenamesData.size(); ++f) {
    ...
    treeData->SetBranchAddress( "GraviMELA",&melaSpinTwoMinimal);
    ...
    for (int i = 0; i < treeData->GetEntries(); i++) {
      ...
      //make plot within 10GeV mass window around the higgs
      if (mass > 120 && mass < 130) {
        histSpinTwoMinimalMELA_Data->Fill(melaSpinTwoMinimal);
        ...
        if (mela > 0.5) {
          histSpinTwoMinimalMELA_AfterMELACut_Data->Fill(melaSpinTwoMinimal);
...
//   gStyle->SetStatOpt(0);
  ...
  legend->AddEntry(histSpinTwoMinimalMELA_SMHiggs, "No Cuts", "L");
  legend->AddEntry(histSpinTwoMinimalMELA_AfterMELACut_SMHiggs, "with MELA > 0.5 Cut", "L");

  histSpinTwoMinimalMELA_SMHiggs->SetLineColor(kRed);
  histSpinTwoMinimalMELA_AfterMELACut_SMHiggs->SetLineColor(kBlack);

  NormalizeHist(histSpinTwoMinimalMELA_SMHiggs);
  NormalizeHist(histSpinTwoMinimalMELA_AfterMELACut_SMHiggs);
  histSpinTwoMinimalMELA_SMHiggs->SetMaximum( 1.2*max(histSpinTwoMinimalMELA_SMHiggs->GetMaximum(),histSpinTwoMinimalMELA_AfterMELACut_SMHiggs->GetMaximum()));
  histSpinTwoMinimalMELA_SMHiggs->Draw("hist");
  histSpinTwoMinimalMELA_AfterMELACut_SMHiggs->Draw("hist,same");
  legend->Draw();
  cv->SaveAs("SpinTwoMinimalMELA_SMHiggs_MELACutImpact.gif");
  ...
  legend->SetBorderSize(0);
  legend->SetFillStyle(0);
  legend->AddEntry(histSpinTwoMinimalMELA_ZZBkg, "No Cuts", "L");
  legend->AddEntry(histSpinTwoMinimalMELA_AfterMELACut_ZZBkg, "with MELA > 0.5 Cut", "L");

  histSpinTwoMinimalMELA_ZZBkg->SetLineColor(kRed);
  histSpinTwoMinimalMELA_AfterMELACut_ZZBkg->SetLineColor(kBlack);

  NormalizeHist(histSpinTwoMinimalMELA_ZZBkg);
  NormalizeHist(histSpinTwoMinimalMELA_AfterMELACut_ZZBkg);
  histSpinTwoMinimalMELA_ZZBkg->SetMaximum( 1.2*max(histSpinTwoMinimalMELA_ZZBkg->GetMaximum(),histSpinTwoMinimalMELA_AfterMELACut_ZZBkg->GetMaximum()));
  histSpinTwoMinimalMELA_ZZBkg->Draw("hist");
  histSpinTwoMinimalMELA_AfterMELACut_ZZBkg->Draw("hist,same");
  legend->Draw();
  cv->SaveAs("SpinTwoMinimalMELA_ZZBkg_MELACutImpact.gif");
  ...
  histCosThetaStar_AfterMELACut_SMHiggs->SetLineColor(kBlack);
  ...
  histCosTheta1_AfterMELACut_SMHiggs->SetLineColor(kBlack);
  ...
  histCosTheta2_AfterMELACut_SMHiggs->SetLineColor(kBlack);
  ...
  histPhi_AfterMELACut_SMHiggs->SetLineColor(kBlack);
  ...
  histPhiStar1_AfterMELACut_SMHiggs->SetLineColor(kBlack);
  ...
  histZ1Mass_AfterMELACut_SMHiggs->SetLineColor(kBlack);
  ...
  histZ2Mass_AfterMELACut_SMHiggs->SetLineColor(kBlack);
  ...
  //*******************************************************************
  // Compare SpinTwoMinimalMELA distribution for signal and bkg
  //*******************************************************************
  cv = new TCanvas("cv", "cv", 800, 600);
  legend = new TLegend(0.60,0.60,0.90,0.80);
  legend->SetTextSize(0.03);
  legend->SetBorderSize(0);
  legend->SetFillStyle(0);
  legend->AddEntry(histSpinTwoMinimalMELA_SMHiggs, "Spin 0", "L");
  legend->AddEntry(histSpinTwoMinimalMELA_SpinTwoMinimalHiggs, "Spin 2", "L");
  legend->AddEntry(histSpinTwoMinimalMELA_ZZBkg, "ZZ Bkg", "L");

  histSpinTwoMinimalMELA_SMHiggs->SetLineColor(kRed);
  histSpinTwoMinimalMELA_SpinTwoMinimalHiggs->SetLineColor(kBlack);
  histSpinTwoMinimalMELA_ZZBkg->SetLineColor(kGreen+2);

  NormalizeHist(histSpinTwoMinimalMELA_SMHiggs);
  NormalizeHist(histSpinTwoMinimalMELA_SpinTwoMinimalHiggs);
  NormalizeHist(histSpinTwoMinimalMELA_ZZBkg);
  histSpinTwoMinimalMELA_SMHiggs->SetMaximum( 1.2*max(max(histSpinTwoMinimalMELA_SMHiggs->GetMaximum(),histSpinTwoMinimalMELA_SpinTwoMinimalHiggs->GetMaximum()),histSpinTwoMinimalMELA_ZZBkg->GetMaximum()));
  histSpinTwoMinimalMELA_SMHiggs->Draw("hist");
  histSpinTwoMinimalMELA_SpinTwoMinimalHiggs->Draw("hist,same");
  histSpinTwoMinimalMELA_ZZBkg->Draw("hist,same");
  legend->Draw();
  cv->SaveAs("SpinTwoMinimalMELA_SignalVsBkg_NoMELACut.gif");
  ...
  legend->SetBorderSize(0);
  legend->SetFillStyle(0);
  legend->AddEntry(histSpinTwoMinimalMELA_AfterMELACut_SMHiggs, "Spin 0", "L");
  legend->AddEntry(histSpinTwoMinimalMELA_AfterMELACut_SpinTwoMinimalHiggs, "Spin 2", "L");
  legend->AddEntry(histSpinTwoMinimalMELA_AfterMELACut_ZZBkg, "ZZ Bkg", "L");

  histSpinTwoMinimalMELA_AfterMELACut_SMHiggs->SetLineColor(kRed);
  histSpinTwoMinimalMELA_AfterMELACut_SpinTwoMinimalHiggs->SetLineColor(kBlack);
  histSpinTwoMinimalMELA_AfterMELACut_ZZBkg->SetLineColor(kGreen+2);

  NormalizeHist(histSpinTwoMinimalMELA_AfterMELACut_SMHiggs);
  NormalizeHist(histSpinTwoMinimalMELA_AfterMELACut_SpinTwoMinimalHiggs);
  NormalizeHist(histSpinTwoMinimalMELA_AfterMELACut_ZZBkg);
  histSpinTwoMinimalMELA_AfterMELACut_SMHiggs->SetMaximum( 1.2*max(max(histSpinTwoMinimalMELA_AfterMELACut_SMHiggs->GetMaximum(),histSpinTwoMinimalMELA_AfterMELACut_SpinTwoMinimalHiggs->GetMaximum()),histSpinTwoMinimalMELA_AfterMELACut_ZZBkg->GetMaximum()));
  histSpinTwoMinimalMELA_AfterMELACut_SMHiggs->Draw("hist");
  histSpinTwoMinimalMELA_AfterMELACut_SpinTwoMinimalHiggs->Draw("hist,same");
  histSpinTwoMinimalMELA_AfterMELACut_ZZBkg->Draw("hist,same");
  legend->Draw();
  cv->SaveAs("SpinTwoMinimalMELA_SignalVsBkg_AfterMELACut.gif");
  ...
  legend->SetBorderSize(0);
  legend->SetFillStyle(0);
  legend->AddEntry(histCosThetaStar_AfterMELACut_SMHiggs, "Spin 0", "L");
  legend->AddEntry(histCosThetaStar_AfterMELACut_SpinTwoMinimalHiggs, "Spin 2", "L");
  //legend->AddEntry(histCosThetaStar_AfterMELACut_ZZBkg, "ZZ Bkg", "L");

  histCosThetaStar_AfterMELACut_SMHiggs->SetLineColor(kRed);
  histCosThetaStar_AfterMELACut_SpinTwoMinimalHiggs->SetLineColor(kBlack);
  histCosThetaStar_AfterMELACut_ZZBkg->SetLineColor(kGreen+2);

  NormalizeHist(histCosThetaStar_AfterMELACut_SMHiggs);
  NormalizeHist(histCosThetaStar_AfterMELACut_SpinTwoMinimalHiggs);
  NormalizeHist(histCosThetaStar_AfterMELACut_ZZBkg);
  histCosThetaStar_AfterMELACut_SMHiggs->SetMaximum( 1.2*max(max(histCosThetaStar_AfterMELACut_SMHiggs->GetMaximum(),histCosThetaStar_AfterMELACut_SpinTwoMinimalHiggs->GetMaximum()),histCosThetaStar_AfterMELACut_ZZBkg->GetMaximum()));
  histCosThetaStar_AfterMELACut_SMHiggs->Draw("hist");
  histCosThetaStar_AfterMELACut_SpinTwoMinimalHiggs->Draw("hist,same");
  //histCosThetaStar_AfterMELACut_ZZBkg->Draw("hist,same");
  legend->Draw();
  cv->SaveAs("CosThetaStar_Spin0VsSpin2_AfterMELACut.gif");
  ...
  legend->SetBorderSize(0);
  legend->SetFillStyle(0);
  legend->AddEntry(histCosTheta1_AfterMELACut_SMHiggs, "Spin 0", "L");
  legend->AddEntry(histCosTheta1_AfterMELACut_SpinTwoMinimalHiggs, "Spin 2", "L");
  //legend->AddEntry(histCosTheta1_AfterMELACut_ZZBkg, "ZZ Bkg", "L");

  histCosTheta1_AfterMELACut_SMHiggs->SetLineColor(kRed);
  histCosTheta1_AfterMELACut_SpinTwoMinimalHiggs->SetLineColor(kBlack);
  histCosTheta1_AfterMELACut_ZZBkg->SetLineColor(kGreen+2);

  NormalizeHist(histCosTheta1_AfterMELACut_SMHiggs);
  NormalizeHist(histCosTheta1_AfterMELACut_SpinTwoMinimalHiggs);
  NormalizeHist(histCosTheta1_AfterMELACut_ZZBkg);
  histCosTheta1_AfterMELACut_SMHiggs->SetMaximum( 1.2*max(max(histCosTheta1_AfterMELACut_SMHiggs->GetMaximum(),histCosTheta1_AfterMELACut_SpinTwoMinimalHiggs->GetMaximum()),histCosTheta1_AfterMELACut_ZZBkg->GetMaximum()));
  histCosTheta1_AfterMELACut_SMHiggs->Draw("hist");
  histCosTheta1_AfterMELACut_SpinTwoMinimalHiggs->Draw("hist,same");
  //histCosTheta1_AfterMELACut_ZZBkg->Draw("hist,same");
  legend->Draw();
  cv->SaveAs("CosTheta1_Spin0VsSpin2_AfterMELACut.gif");
  ...
  legend->SetBorderSize(0);
  legend->SetFillStyle(0);
  legend->AddEntry(histCosTheta2_AfterMELACut_SMHiggs, "Spin 0", "L");
  legend->AddEntry(histCosTheta2_AfterMELACut_SpinTwoMinimalHiggs, "Spin 2", "L");
  //legend->AddEntry(histCosTheta2_AfterMELACut_ZZBkg, "ZZ Bkg", "L");

  histCosTheta2_AfterMELACut_SMHiggs->SetLineColor(kRed);
  histCosTheta2_AfterMELACut_SpinTwoMinimalHiggs->SetLineColor(kBlack);
  histCosTheta2_AfterMELACut_ZZBkg->SetLineColor(kGreen+2);

  NormalizeHist(histCosTheta2_AfterMELACut_SMHiggs);
  NormalizeHist(histCosTheta2_AfterMELACut_SpinTwoMinimalHiggs);
  NormalizeHist(histCosTheta2_AfterMELACut_ZZBkg);
  histCosTheta2_AfterMELACut_SMHiggs->SetMaximum( 1.2*max(max(histCosTheta2_AfterMELACut_SMHiggs->GetMaximum(),histCosTheta2_AfterMELACut_SpinTwoMinimalHiggs->GetMaximum()),histCosTheta2_AfterMELACut_ZZBkg->GetMaximum()));
  histCosTheta2_AfterMELACut_SMHiggs->Draw("hist");
  histCosTheta2_AfterMELACut_SpinTwoMinimalHiggs->Draw("hist,same");
  //histCosTheta2_AfterMELACut_ZZBkg->Draw("hist,same");
  legend->Draw();
  cv->SaveAs("CosTheta2_Spin0VsSpin2_AfterMELACut.gif");
  ...
  legend->SetBorderSize(0);
  legend->SetFillStyle(0);
  legend->AddEntry(histPhi_AfterMELACut_SMHiggs, "Spin 0", "L");
  legend->AddEntry(histPhi_AfterMELACut_SpinTwoMinimalHiggs, "Spin 2", "L");
  //legend->AddEntry(histPhi_AfterMELACut_ZZBkg, "ZZ Bkg", "L");

  histPhi_AfterMELACut_SMHiggs->SetLineColor(kRed);
  histPhi_AfterMELACut_SpinTwoMinimalHiggs->SetLineColor(kBlack);
  histPhi_AfterMELACut_ZZBkg->SetLineColor(kGreen+2);

  NormalizeHist(histPhi_AfterMELACut_SMHiggs);
  NormalizeHist(histPhi_AfterMELACut_SpinTwoMinimalHiggs);
  NormalizeHist(histPhi_AfterMELACut_ZZBkg);
  histPhi_AfterMELACut_SMHiggs->SetMaximum( 1.2*max(max(histPhi_AfterMELACut_SMHiggs->GetMaximum(),histPhi_AfterMELACut_SpinTwoMinimalHiggs->GetMaximum()),histPhi_AfterMELACut_ZZBkg->GetMaximum()));
  histPhi_AfterMELACut_SMHiggs->Draw("hist");
  histPhi_AfterMELACut_SpinTwoMinimalHiggs->Draw("hist,same");
  //histPhi_AfterMELACut_ZZBkg->Draw("hist,same");
  legend->Draw();
  cv->SaveAs("Phi_Spin0VsSpin2_AfterMELACut.gif");
  ...
  legend->SetBorderSize(0);
  legend->SetFillStyle(0);
  legend->AddEntry(histPhiStar1_AfterMELACut_SMHiggs, "Spin 0", "L");
  legend->AddEntry(histPhiStar1_AfterMELACut_SpinTwoMinimalHiggs, "Spin 2", "L");
  //legend->AddEntry(histPhiStar1_AfterMELACut_ZZBkg, "ZZ Bkg", "L");

  histPhiStar1_AfterMELACut_SMHiggs->SetLineColor(kRed);
  histPhiStar1_AfterMELACut_SpinTwoMinimalHiggs->SetLineColor(kBlack);
  histPhiStar1_AfterMELACut_ZZBkg->SetLineColor(kGreen+2);

  NormalizeHist(histPhiStar1_AfterMELACut_SMHiggs);
  NormalizeHist(histPhiStar1_AfterMELACut_SpinTwoMinimalHiggs);
  NormalizeHist(histPhiStar1_AfterMELACut_ZZBkg);
  histPhiStar1_AfterMELACut_SMHiggs->SetMaximum( 1.2*max(max(histPhiStar1_AfterMELACut_SMHiggs->GetMaximum(),histPhiStar1_AfterMELACut_SpinTwoMinimalHiggs->GetMaximum()),histPhiStar1_AfterMELACut_ZZBkg->GetMaximum()));
  histPhiStar1_AfterMELACut_SMHiggs->Draw("hist");
  histPhiStar1_AfterMELACut_SpinTwoMinimalHiggs->Draw("hist,same");
  //histPhiStar1_AfterMELACut_ZZBkg->Draw("hist,same");
  legend->Draw();
  cv->SaveAs("PhiStar1_Spin0VsSpin2_AfterMELACut.gif");
  ...
  legend->SetBorderSize(0);
  legend->SetFillStyle(0);
  legend->AddEntry(histZ1Mass_AfterMELACut_SMHiggs, "Spin 0", "L");
  legend->AddEntry(histZ1Mass_AfterMELACut_SpinTwoMinimalHiggs, "Spin 2", "L");
  //legend->AddEntry(histZ1Mass_AfterMELACut_ZZBkg, "ZZ Bkg", "L");

  histZ1Mass_AfterMELACut_SMHiggs->SetLineColor(kRed);
  histZ1Mass_AfterMELACut_SpinTwoMinimalHiggs->SetLineColor(kBlack);
  histZ1Mass_AfterMELACut_ZZBkg->SetLineColor(kGreen+2);

  NormalizeHist(histZ1Mass_AfterMELACut_SMHiggs);
  NormalizeHist(histZ1Mass_AfterMELACut_SpinTwoMinimalHiggs);
  NormalizeHist(histZ1Mass_AfterMELACut_ZZBkg);
  histZ1Mass_AfterMELACut_SMHiggs->SetMaximum( 1.2*max(max(histZ1Mass_AfterMELACut_SMHiggs->GetMaximum(),histZ1Mass_AfterMELACut_SpinTwoMinimalHiggs->GetMaximum()),histZ1Mass_AfterMELACut_ZZBkg->GetMaximum()));
  histZ1Mass_AfterMELACut_SMHiggs->Draw("hist");
  histZ1Mass_AfterMELACut_SpinTwoMinimalHiggs->Draw("hist,same");
  //histZ1Mass_AfterMELACut_ZZBkg->Draw("hist,same");
  legend->Draw();
  cv->SaveAs("Z1Mass_Spin0VsSpin2_AfterMELACut.gif");
  ...
  legend->SetBorderSize(0);
  legend->SetFillStyle(0);
  legend->AddEntry(histZ2Mass_AfterMELACut_SMHiggs, "Spin 0", "L");
  legend->AddEntry(histZ2Mass_AfterMELACut_SpinTwoMinimalHiggs, "Spin 2", "L");
  //legend->AddEntry(histZ2Mass_AfterMELACut_ZZBkg, "ZZ Bkg", "L");

  histZ2Mass_AfterMELACut_SMHiggs->SetLineColor(kRed);
  histZ2Mass_AfterMELACut_SpinTwoMinimalHiggs->SetLineColor(kBlack);
  histZ2Mass_AfterMELACut_ZZBkg->SetLineColor(kGreen+2);

  NormalizeHist(histZ2Mass_AfterMELACut_SMHiggs);
  NormalizeHist(histZ2Mass_AfterMELACut_SpinTwoMinimalHiggs);
  NormalizeHist(histZ2Mass_AfterMELACut_ZZBkg);
  histZ2Mass_AfterMELACut_SMHiggs->SetMaximum( 1.2*max(max(histZ2Mass_AfterMELACut_SMHiggs->GetMaximum(),histZ2Mass_AfterMELACut_SpinTwoMinimalHiggs->GetMaximum()),histZ2Mass_AfterMELACut_ZZBkg->GetMaximum()));
  histZ2Mass_AfterMELACut_SMHiggs->Draw("hist");
  histZ2Mass_AfterMELACut_SpinTwoMinimalHiggs->Draw("hist,same");
  //histZ2Mass_AfterMELACut_ZZBkg->Draw("hist,same");
  legend->Draw();
  cv->SaveAs("Z2Mass_Spin0VsSpin2_AfterMELACut.gif");
...
void PlotTemplates(string filename) {
  ...
  TH2F* hist2D_spin2minimalsig_em = (TH2F*)file->Get("hist2D_spin2minimalsig_em");
  TH2F* hist2D_spin2minimalsig_ee = (TH2F*)file->Get("hist2D_spin2minimalsig_ee");
  TH2F* hist2D_spin2minimalsig_mm = (TH2F*)file->Get("hist2D_spin2minimalsig_mm");
  ...
  SetTemplateDrawOptions(hist2D_spin2minimalsig_em);
  SetTemplateDrawOptions(hist2D_spin2minimalsig_ee);
  SetTemplateDrawOptions(hist2D_spin2minimalsig_mm);
  ...
  cv->SaveAs("SpinTwoMinimalMELAMassTemplate_sig_em.png");
  hist2D_sig_ee->Draw("colz");
  cv->SaveAs("SpinTwoMinimalMELAMassTemplate_sig_ee.png");
  hist2D_sig_mm->Draw("colz");
  cv->SaveAs("SpinTwoMinimalMELAMassTemplate_sig_mm.png");

  hist2D_spin2minimalsig_em->Draw("colz");
  cv->SaveAs("SpinTwoMinimalMELAMassTemplate_spin2minimalsig_em.png");
  hist2D_spin2minimalsig_ee->Draw("colz");
  cv->SaveAs("SpinTwoMinimalMELAMassTemplate_spin2minimalsig_ee.png");
  hist2D_spin2minimalsig_mm->Draw("colz");
  cv->SaveAs("SpinTwoMinimalMELAMassTemplate_spin2minimalsig_mm.png");

  hist2D_bkg_em->Draw("colz");
  cv->SaveAs("SpinTwoMinimalMELAMassTemplate_bkg_em.png");
  hist2D_bkg_ee->Draw("colz");
  cv->SaveAs("SpinTwoMinimalMELAMassTemplate_bkg_ee.png");
  hist2D_bkg_mm->Draw("colz");
  cv->SaveAs("SpinTwoMinimalMELAMassTemplate_bkg_mm.png");

  hist2D_bkg_em_up->Draw("colz");
  cv->SaveAs("SpinTwoMinimalMELAMassTemplate_bkg_em_up.png");
  hist2D_bkg_ee_up->Draw("colz");
  cv->SaveAs("SpinTwoMinimalMELAMassTemplate_bkg_ee_up.png");
  hist2D_bkg_mm_up->Draw("colz");
  cv->SaveAs("SpinTwoMinimalMELAMassTemplate_bkg_mm_up.png");


}

void MakeSpinTwoMinimalMELAPlots() {
  ...
  zzbkgfilenames.push_back( pair<string,double>("/data1/sixie/ntuples/step3new/HZZ4L_53X_S1_V11_S2_V02/MC/8TeV/yesRegrYesCalibYesMu/hzzTree_id102.root",getBkgXsec(102)/evt_8TeV(102)) );
  zzbkgfilenames.push_back( pair<string,double>("/data1/sixie/ntuples/step3new/HZZ4L_53X_S1_V11_S2_V02/MC/8TeV/yesRegrYesCalibYesMu/hzzTree_id103.root",getBkgXsec(103)/evt_8TeV(103)) );
  zzbkgfilenames.push_back( pair<string,double>("/data1/sixie/ntuples/step3new/HZZ4L_53X_S1_V11_S2_V02/MC/8TeV/yesRegrYesCalibYesMu/hzzTree_id104.root",getBkgXsec(104)/evt_8TeV(104)) );
  zzbkgfilenames.push_back( pair<string,double>("/data1/sixie/ntuples/step3new/HZZ4L_53X_S1_V11_S2_V02/MC/8TeV/yesRegrYesCalibYesMu/hzzTree_id105.root",getBkgXsec(105)/evt_8TeV(105)) );
  zzbkgfilenames.push_back( pair<string,double>("/data1/sixie/ntuples/step3new/HZZ4L_53X_S1_V11_S2_V02/MC/8TeV/yesRegrYesCalibYesMu/hzzTree_id106.root",getBkgXsec(106)/evt_8TeV(106)) );
  zzbkgfilenames.push_back( pair<string,double>("/data1/sixie/ntuples/step3new/HZZ4L_53X_S1_V11_S2_V02/MC/8TeV/yesRegrYesCalibYesMu/hzzTree_id107.root",getBkgXsec(107)/evt_8TeV(107)) );
  zzbkgfilenames.push_back( pair<string,double>("/data1/sixie/ntuples/step3new/HZZ4L_53X_S1_V11_S2_V02/MC/8TeV/yesRegrYesCalibYesMu/hzzTree_id101.root",getBkgXsec(101)/evt_8TeV(101)) );
  zzbkgfilenames.push_back( pair<string,double>("/data1/sixie/ntuples/step3new/HZZ4L_53X_S1_V11_S2_V02/MC/8TeV/yesRegrYesCalibYesMu/hzzTree_id100.root",getBkgXsec(100)/evt_8TeV(100)) );
  ...
  //define data samples
  vector<string> filenamesData;
  filenamesData.push_back( "/data1/sixie/ntuples/step3new/HZZ4L_53X_S1_V11_S2_V02/MC/8TeV/yesRegrYesCalibYesMu/hcp.root");
  filenamesData.push_back( "/data1/sixie/ntuples/step3new/HZZ4L_42X_S1_V11_S2_V02/MC/7TeV/yesRegrYesCalibYesMu/hcp.root");


//    MakeSpinTwoMinimalPlots( "/data1/sixie/ntuples/step3new/HZZ4L_53X_S1_V11_S2_V02/MC/8TeV/yesRegrYesCalibYesMu/hzzTree_id1125.root", 
//                           "/data1/sixie/ntuples/step3new/HZZ4L_53X_S1_V11_S2_V02/MC/8TeV/yesRegrYesCalibYesMu/hzzTree_id9125.root", 
//                           zzbkgfilenames, filenamesData );

    PlotTemplates("SpinTwoMinimalMelaVsMass2DShapes.root");
