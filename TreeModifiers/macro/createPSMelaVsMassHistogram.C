...
//     fillBkg (h2D_bkg_em, h2D_bkg_mm, h2D_bkg_ee);
    ...
    //***********************************************************************************************
    fillMass("/MC/8TeV/yesRegrYesCalib/hzzTree_id7110.root", false, h2D_pssig_em, h2D_pssig_mm, h2D_pssig_ee);
    fillMass("/MC/8TeV/yesRegrYesCalib/hzzTree_id7120.root", false, h2D_pssig_em, h2D_pssig_mm, h2D_pssig_ee);
    fillMass("/MC/8TeV/yesRegrYesCalib/hzzTree_id7125.root", false, h2D_pssig_em, h2D_pssig_mm, h2D_pssig_ee);
    fillMass("/MC/8TeV/yesRegrYesCalib/hzzTree_id7130.root", false, h2D_pssig_em, h2D_pssig_mm, h2D_pssig_ee);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    smooth(&h2D_pssig_em,    binmin1, binmax1, 1);
    smooth(&h2D_pssig_mm,    binmin1, binmax1, 1);
    smooth(&h2D_pssig_ee,    binmin1, binmax1, 1);
    ...
    smooth(&h2D_pssig_em,    binmin2, binmax2, 2);
    smooth(&h2D_pssig_mm,    binmin2, binmax2, 2);
    smooth(&h2D_pssig_ee,    binmin2, binmax2, 2);
    ...
    smooth(&h2D_pssig_em,    binmin3, binmax3, 3);
    smooth(&h2D_pssig_mm,    binmin3, binmax3, 3);
    smooth(&h2D_pssig_ee,    binmin3, binmax3, 3);
