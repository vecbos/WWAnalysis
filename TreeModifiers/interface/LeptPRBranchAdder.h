#ifndef TreeModifiers_LeptPRBranchAdder_h
#define TreeModifiers_LeptPRBranchAdder_h
...
class LeptPRBranchAdder : public BranchAdder {
 public:
 LeptPRBranchAdder(const edm::ParameterSet& pset) ;
  
  virtual ~LeptPRBranchAdder(){
